(function (angular) {
  ...
  function AppConfig($routeProvider, $locationProvider,
    ...
    $translateProvider.translations('vi', {
      ...
      BTN_FOLLOW: 'Đang theo dõi',
      BTN_UNFOLLOW: 'Theo dõi',
      ...
      LABEL_LEADERBOARD_WEEK: 'Tuần này',
      LABEL_LEADERBOARD_MONTH: 'Tháng này',
      LABEL_LEADERBOARD_ALL_TIME: 'Tất cả',
      ...
      TEXT_JUDGE_QUESTION_TITLE: 'Đánh dấu tất cả đáp án đúng',
      ...
      TEXT_ThOOLTIP_SHORTCUT_KEYBOARD: 'Chọn phím tắt {value} để lựa chọn câu trả lời',
