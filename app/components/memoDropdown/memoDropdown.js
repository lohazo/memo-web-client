/*
 * memoDropdown - Provides dropdown menu functionality
 * @restrict class or attribute
 * @example:

   <a memo-dropdown="#dropdown-menu">My Dropdown Menu</a>
 ...
 */
angular.module('memo.dropdown', ['mm.foundation.position', 'mm.foundation.mediaQueries',
    'mm.foundation.stylesheets'
  ])
  .directive('memoDropdown', ['$document', '$window', '$location', '$position', 'stylesheetFactory', function (
    $document,
    ...
    return {
      ...
      link: function (scope, element, attrs, controller) {
        ...
        var dropdown = angular.element($document[0].querySelector(scope.memoDropdown));
        ...
        var onClick = function (event) {
          dropdown = angular.element($document[0].querySelector(scope.memoDropdown));
          var distanceToScroll = Number(dropdown.css('height').replace('px', '')) + 90;
