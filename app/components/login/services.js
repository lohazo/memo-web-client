(function(angular) {
  ...
  // function AuthService($rootScope, $localStorage, $routeParams, Facebook, GooglePlus, EcoTracker, MemoTracker, LoginService, MolServices) {
  //   var Service = {};
  ...
  angular.module('login.services')
    .factory('AuthService', ['$rootScope', '$localStorage', '$routeParams',
    'Facebook', 'GooglePlus', 'EcoTracking', 'MemoTracking',
    'LoginService', 'MolServices', function ($rootScope, $localStorage, $routeParams, Facebook, GooglePlus, EcoTracker, MemoTracker, LoginService, MolServices) {
