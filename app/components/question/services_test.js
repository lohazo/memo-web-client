...
describe('Service', function () {
  ...
  describe('Question.checkTypoOnString', function () {
    ...
    it('should return a formatted array', function () {
      ...
      expect(service.checkTypoOnString('Tôi là một nguời đàn ông', 'Tôi là một người đàn ông')).toContain([
        3, 5
      ]);
  ...
  describe('Question.createLastScreenText', function () {
    var service;
    ...
    it('check if createLastScreenText exists', function () {
      expect(service.createLastScreenText).toBeDefined();
    });

    it('should return formatted string', function () {
      var data = {
        text: 'Chúc mừng hainp! Bạn đã nhận được học bổng của TOPICA Native.',
        offsets: [{
          text: 'hainp',
          offset: [10, 5],
          color: '#333333',
      ...
      expect(service.createLastScreenText(data)).toBe(
        'Chúc mừng <b color="#333333">hainp</b>! Bạn đã nhận được học bổng của <b color="#810c15">TOPICA Native</b>.'
      )
    });

    it('should return formatted string', function () {
      var data = {
        text: 'Chúc mừng hainp! Bạn đã nhận được học bổng của TOPICA Native tri gia 5 MemoCoin',
        offsets: [{
          text: 'hainp',
          offset: [10, 5],
          color: '#333333',
      ...
      expect(service.createLastScreenText(data)).toBe(
        'Chúc mừng <b color="#333333">hainp</b>! Bạn đã nhận được học bổng của <b color="#810c15">TOPICA Native</b> tri gia <b color="#333333">5</b> MemoCoin'
      )
    });
  });
});