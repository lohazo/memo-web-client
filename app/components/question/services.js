    ...
    angular.module('question.services', ['diff-match-patch'])
        .factory('Question', ['dmp', function(dmp) {
            ...
            function checkTypoOnWord(word, correctWord) {
                ...
                if (removeDiacritics(word) === removeDiacritics(correctWord)) {
                    result.isTypo = true;
                    return result;
                }
                ...
                for (var i = 0; i < word.length; i++) {
                    numberOfDiffs += (word[i] === correctWord[i]) ? 0 : 1;
                };
                ...
                // var diffs = dmp.diff_main(word, correctWord);
                // var numberOfDiffs = diffs.filter(function(diff) {
