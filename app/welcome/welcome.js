(function(angular) {
  ...
  function PlayerCarouselCtrl($scope, AppSetting) {
    $scope.slideIndex = 0;
  ...
  angular.module('welcome')
    ...
    .controller('PlayerCarouselCtrl', ['$scope', 'AppSetting', PlayerCarouselCtrl]);
  angular.module('welcome')
  ...
  angular.module('welcome')
    .directive('playerContainerCarousel', function($location) {
      return {
        strict: 'EA',
        scope: true,
